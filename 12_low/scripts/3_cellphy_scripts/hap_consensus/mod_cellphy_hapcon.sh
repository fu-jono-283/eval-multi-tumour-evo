...
#SBATCH --output=data/3_cellphy_log/hapcon/%j_hapcon.out
...
process_hapcon_folder() {
    local iteration_identifier="_pop99551_sites84817r8"
    local iteration_folder="$single_ccoal_output_folder/_pop99551_sites84817r8"
    ...
    cellphy.sh RAXML --msa "$hapconsensus_file" --model GT16+FO+E --seed 2 --threads 15 --force perf_threads --prefix "$hapcon_output_prefix"
}

execute_r_script() {
    local iteration_identifier="_pop99551_sites84817r8"
    local iteration_folder="$single_ccoal_output_folder/_pop99551_sites84817r8"
    local species_tree_file="$simphy_folder/_pop99551_sites84817r8/s_tree.trees"
...
log_file="data/3_cellphy_log/hapcon/master_log.txt"
echo "Job started at $(date)" >> "$log_file"

mv "data/3_cellphy_log/hapcon/${SLURM_JOB_ID}_hapcon.out" "data/3_cellphy_log/hapcon/_pop99551_sites84817r8_${SLURM_JOB_ID}_hapcon.out"
