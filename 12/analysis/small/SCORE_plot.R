...
plot <- ggplot(data = long_data, aes(x = Score, y = species_birth_rate, color = Method)) +
  ...
  ggtitle("Phylogenetic Accuracy vs. Metastatic Rate: Comparison of Three Methods (MR-Full)") +  
  theme_minimal() + 
  theme(
...
ggsave("12/results/small_scores/z_single_plot.png", plot, width = 3.5, height = 2.5, dpi = 320, bg = "white")
