...
process_concat_folder() {
    local iteration_identifier="_pop93861_sites94324"
    local iteration_folder="$concat_iterations/_pop93861_sites94324"
...
mv "logs/3_cellphy_log/vcf_concat/${SLURM_JOB_ID}_concat.out" "logs/3_cellphy_log/vcf_concat/_pop93861_sites94324_${SLURM_JOB_ID}_concat.out"

process_concat_folder "_pop93861_sites94324"
execute_r_script "_pop93861_sites94324"
