...
process_hapcon_folder() {
    ...
    cellphy.sh RAXML --msa "$hapconsensus_file" --model GT16+FO+E --seed 2 --threads 6 --force perf_threads --prefix "$hapcon_output_prefix" --redo
}
...
mv "data/3_cellphy_log/hapcon/${SLURM_JOB_ID}_hapcon.out" "data/3_cellphy_log/hapcon/_pop99731_sites74578r8_${SLURM_JOB_ID}_hapcon.out"
