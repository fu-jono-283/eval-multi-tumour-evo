...
kable_table <- kable(glm_summary_with_stars, format = "html", align = "c", caption = "GLM on Phylogenetic Accuracy of Reconstructed ASTRAL Trees (MR-Full)") %>%
  kable_styling(
...
save_path_png <- "12/results/big_scores/astralGLM.png"
...
plot(ASTRAL_r2, scale = "r2", main = "Subset Selection - Phylogenetic Accuracy of Reconstructed ASTRAL Trees (MR-Full)")
dev.off()