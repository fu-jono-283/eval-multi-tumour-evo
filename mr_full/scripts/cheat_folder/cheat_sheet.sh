...
template_df <- read.csv("dataframes/part1_template/combined_data_120-Copy1.csv")
...
for (subdir in subdirs) {
  csv_file <- file.path(subdir, "combined_data_120.csv")
...
write.csv(template_df, "dataframes/small_scores.csv", row.names = FALSE)
