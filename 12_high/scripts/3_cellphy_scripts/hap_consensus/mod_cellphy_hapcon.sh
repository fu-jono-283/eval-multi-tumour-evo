...
process_hapcon_folder() {
    ...
    local iteration_folder="$single_ccoal_output_folder/_pop99902_sites24572r8"
...
execute_r_script() {
    local iteration_identifier="_pop99902_sites24572r8"
    local iteration_folder="$single_ccoal_output_folder/_pop99902_sites24572r8"
    local species_tree_file="$simphy_folder/_pop99902_sites24572r8/s_tree.trees"
...
mv "data/3_cellphy_log/hapcon/${SLURM_JOB_ID}_hapcon.out" "data/3_cellphy_log/hapcon/_pop99902_sites24572r8_${SLURM_JOB_ID}_hapcon.out"
