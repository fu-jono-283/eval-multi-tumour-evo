...
process_concat_folder() {
    local iteration_identifier="_pop91289_sites98305"
    local iteration_folder="$concat_iterations/_pop91289_sites98305"
...
mv "logs/3_cellphy_log/vcf_concat/${SLURM_JOB_ID}_concat.out" "logs/3_cellphy_log/vcf_concat/_pop91289_sites98305_${SLURM_JOB_ID}_concat.out"

process_concat_folder "_pop91289_sites98305"
execute_r_script "_pop91289_sites98305"
