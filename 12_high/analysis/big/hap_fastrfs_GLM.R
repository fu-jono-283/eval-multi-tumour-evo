...
kable_table <- kable(glm_summary_with_stars, format = "html", align = "c", caption = "GLM on Phylogenetic Accuracy of FastRFS on H-CS Trees (MR-high)") %>%
  kable_styling(
...
save_path_png <- "12_high/results/big_scores/hap_fastrfsGLM.png"
...
plot(hap_FastRFS_r2, scale = "r2", main = "Subset Selection - Phylogenetic Accuracy of FastRFS on H-CS Trees (MR-high)")
