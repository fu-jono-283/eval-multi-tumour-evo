...
kable_table <- kable(glm_summary_with_stars, format = "html", align = "c", caption = "GLM on Phylogenetic Accuracy of Concatenated VCF-PB Trees (MR-High)") %>%
  kable_styling(
...
save_path_png <- "12_high/results/big_scores/vcf_concatGLM.png"
...
plot(VCF_concat_r2, scale = "r2", main = "Subset Selection on Phylogenetic Accuracy of Concatenated VCF-PB Trees (MR-High)")
