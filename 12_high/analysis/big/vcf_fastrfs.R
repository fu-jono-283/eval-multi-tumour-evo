...
kable_table <- kable(glm_summary_with_stars, format = "html", align = "c", caption = "GLM on Phylogenetic Accuracy of FastRFS on VCF-PB Trees (MR-High)") %>%
  kable_styling(
...
save_path_png <- "12_high/results/big_scores/vcf_fastrfsGLM.png"
...
plot(vcf_FastRFS_r2, scale = "r2", main = "Subset Selection - Phylogenetic Accuracy of FastRFS on VCF-PB Trees")
