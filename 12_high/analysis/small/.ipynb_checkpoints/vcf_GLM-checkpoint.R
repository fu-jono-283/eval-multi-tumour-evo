...
kable_table <- kable(glm_summary_with_stars, format = "html", align = "c", caption = "GLM on Phylogenetic Accuracy of Reconstructed VCF Pseudobulk Trees (MR-High)", escape = FALSE) %>%
  kable_styling(
...
save_path_png <- "12_high/results/small_scores/vcfGLM.png"
...
plot(single_r2, scale = "r2", main = "Subset Selection - Phylogenetic Accuracy of Reconstructed VCF Pseudobulk Trees (MR-High)")
