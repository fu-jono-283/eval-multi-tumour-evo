...
cellphy_concat_sh <- readLines("scripts/3_cellphy_scripts/concat/cellphy_concat.sh")
...
writeLines(modified_concat_script, "scripts/3_cellphy_scripts/concat/mod_cellphy_concat.sh")

cmd_cellphy_concat <- paste("sbatch scripts/3_cellphy_scripts/concat/mod_cellphy_concat.sh", sep="")
